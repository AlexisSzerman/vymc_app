...
const MeetingHistory = () => {
  ...
  // Obtenemos los valores únicos para fecha, sala y asignacion
  ...
  const filtrarReuniones = (reunion) => {
    const { fecha, sala, asignacion, titular, ayudante } = filtro;
    ...
    <div className='container mb-4'>
      ...
      <div className="row mb-3 justify-content-center">
        <div className="col-md-2">
          <input type="text" name="titular" value={filtro.titular} onChange={handleChange} placeholder="Filtrar por Titular" className="form-control mb-2" />
        </div>
        <div className="col-md-2">
          <input type="text" name="ayudante" value={filtro.ayudante} onChange={handleChange} placeholder="Filtrar por Ayudante" className="form-control mb-2" />
        </div>
        <div className="col-md-2">
